 ...
 */
@Configuration
@MapperScan(basePackages = "com.lucifer.log.mapper", sqlSessionFactoryRef = "secondSqlSessionFactory")
public class MybatisDatasourceConfig2 {

    @Bean(name = "secondDataSource")
    public DataSource secondDataSource(DBConfig2 dbConfig2) throws SQLException {
        //获取mysqlXaDataSource
